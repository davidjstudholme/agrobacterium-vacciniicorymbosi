...
./datasets download genome accession --inputfile accession.txt --include genome --filename xanthomonas_genome_assemblies.zip
...
### Rename the file
mv GCA_000442985.1_AtP4V1.0_genomic.fna  A_fabacearum_P4.fasta
